...
A true color image displays the red, green, and blue bands as they would appear to the human eye. Often raw satellite contains extreme values that can make the rest of the image look washed out when plotting. 

```{python}
#| fig-cap: "True color composite (RGB) of the fire-affected area before handling nan and 0s"
...
This can be corrected by handling outliers and missing values properly
