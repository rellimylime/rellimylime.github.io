...
**Palisades Fire Area:** The affected census tracts show predominantly low to moderate percentile rankings (light to medium orange colors, roughly 10th-40th percentiles). This indicates that the Palisades fire primarily impacted areas with relatively **lower proportions of low-income residents** compared to the state average—reflecting the area's generally higher socioeconomic status along the Pacific coast.

**Eaton Fire Area:** The burn area shows significantly higher percentile rankings, with large portions in the 50th-70th percentiles (darker orange) and some tracts reaching the 80th-90th percentiles (approaching dark red). The northern portions of the Eaton fire area, particularly around Altadena, show the highest vulnerability rankings. This demonstrates that the Eaton fire disproportionately affected communities with **higher concentrations of economically vulnerable residents**.

**Environmental Justice Implications:** The contrasting patterns reveal that while both fires caused extensive physical damage, the Eaton fire imposed greater socioeconomic burden on vulnerable populations who typically have fewer resources for evacuation, temporary housing, and long-term recovery. This disparity is crucial for:
