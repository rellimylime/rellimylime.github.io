...
where: - $Y_i$ is the count of roadkill events on segment $i$ - $\mu_i$ is the expected count given occurrence - $\theta$ is the dispersion parameter - $\log(\text{Length}_i)$ is an offset controlling for road segment exposure
