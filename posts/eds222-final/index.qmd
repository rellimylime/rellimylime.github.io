...
# Core colors for all visualizations
primary_color <- "#2A9D8F"    # Forest teal - main color
accent_color <- "#E76F51"     # Warm coral - secondary/accent
text_dark <- "#2B2D42"
text_mid <- "#5A5A5A"
bg_warm <- "#FFFEF9"
...
# Plot DAG
ggdag(roadkill_dag, text_size = 3.8, node_size = 18) +
  theme_dag() +
  geom_dag_point(color = primary_color, size = 18) +
  geom_dag_edges(edge_color = text_mid) +
