...
temp_summary <- data.frame(
  ...
  Temperature_C = c(
    round(global(sst_mean_c, fun = "min", na.rm = TRUE)[[1]], 2),
    round(global(sst_mean_c, fun = function(x) quantile(x, 0.25, na.rm = TRUE))[[1]], 2),
    round(global(sst_mean_c, fun = "median", na.rm = TRUE)[[1]], 2),
    round(global(sst_mean_c, fun = "mean", na.rm = TRUE)[[1]], 2),
    round(global(sst_mean_c, fun = function(x) quantile(x, 0.75, na.rm = TRUE))[[1]], 2),
    round(global(sst_mean_c, fun = "max", na.rm = TRUE)[[1]], 2)
  )
)
