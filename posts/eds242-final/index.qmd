...
-   Historical analogs (when similar heat waves hit in the past, what happened?)
-   Empirical relationships (how does actual solar generation track with weather obs?)
-   Expert elicitation (what do grid operators and solar engineers see on the ground?)
