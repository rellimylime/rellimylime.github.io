...
date: 2026-03-12
categories: [Personal, MEDS, Reflection]
...
.sticky-card img.course-visual {
  ...
  border-radius: 10px;
  border: 1px solid rgba(112, 146, 194, 0.18);
...
This timeline follows the official MEDS sequence you shared: Summer Session B (EDS 212, 214, 217, 221), Fall (EDS 220, 222, 223, 242), Winter (EDS 230, 240, 241 plus capstone 411A), and Spring (EDS 213, 232 plus capstone 411B).
:::
::::
...
[**Big Idea**]{.teal-text .body-text-s} statistics is a framework for uncertainty-aware decisions, not just a menu of tests.
...
[Fall 2025]{style="font-size: 1rem; letter-spacing: 0.08em; text-transform: uppercase; opacity: 0.7; margin-bottom: 1rem; display: block;"} [Datasets, Space, and Ethics]{.giant-title .white-text} [EDS 220, EDS 223, and EDS 242]{.subtitle-text .white-text style="opacity: 0.75;"}
:::
...
![EDS 220 wildfire visualization](../../images/posts/eds220-final/LAfire.webp){.course-visual}
...
**EDS 223 and EDS 242: Geospatial Analysis and Ethics**
:::
:::::

::::::::: {.cr-section cr-layout="sidebar-left"}
:::: {focus-on="cr-eds223-card" style="height: 66vh;"}
::: {.body-text-m style="margin-right: 40px;"}
...
:::: {focus-on="cr-eds242-card" style="height: 66vh;"}
::: {.body-text-m style="margin-right: 40px;"}
...
::: {#cr-eds223-card .sticky-card style="padding: 36px; margin-top: 40px;"}
![EDS 223 census-tract impact map](../eds223-final/index_files/figure-html/fig_tract_impacts-1.png){.course-visual}
...
[Read the EDS 223 final post](../eds223-final/){.body-text-s}
:::

::: {#cr-eds242-card .sticky-card style="padding: 36px; margin-top: 40px;"}
![EDS 242 marine layer visual](../../images/posts/eds242-final/marin-fog.webp){.course-visual}
...
[Read the EDS 242 final post](../eds242-final/){.body-text-s}
:::
:::::::::
...
![EDS 240 infographic on framing and crash statistics](../../images/posts/eds240-final/draft2.png){.course-visual}
...
**EDS 241 and EDS 230: Causal Inference and Modeling**
:::
:::::

::::::::: {.cr-section cr-layout="sidebar-right"}
:::: {focus-on="cr-eds241-card" style="height: 66vh;"}
::: {.body-text-m style="margin-left: 40px;"}
...
:::: {focus-on="cr-eds230-card" style="height: 66vh;"}
::: {.body-text-m style="margin-left: 40px;"}
...
::: {#cr-eds241-card .sticky-card style="padding: 36px; margin-top: 40px;"}
...
::: {#cr-eds230-card .sticky-card style="padding: 36px; margin-top: 40px;"}
![EDS 230 conceptual modeling workflow](../../images/posts/meds-story/eds230-conceptual-model.png){.course-visual}
...
[View the EDS 230 course repository](https://github.com/rellimylime/EDS-230-ESM-232-W26/tree/main){.body-text-s}
:::
:::::::::
...
[Research in Parallel]{.giant-title .white-text} [coursework plus lab application]{.subtitle-text .white-text style="opacity: 0.75;"}
:::
...
![FIA database project thumbnail](../../images/posts/forest-data-compilation/fia-thumbnail.jpeg){.course-visual}
...
![Garmin calendar sync project image](../../images/posts/garmin-calendar-sync/garmin-calendar.jpg){.course-visual}
...
::: {style="width:60px;height:3px;background:linear-gradient(90deg,#2A9D8F,#E76F51,#F4A261);border-radius:2px;margin:1rem 0 1.5rem;opacity:0.7;"}
:::

::: {style="display:grid;grid-template-columns:1fr 1fr;gap:0.65rem;"}
[R - tidyverse]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Python - pandas]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Git - GitHub]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Quarto]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [ggplot2]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [sf - terra]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [rioxarray]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [STAC / Planetary Computer]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Statistical inference]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Causal inference]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Remote sensing]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [R package dev]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Logistic / Poisson regression]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Difference-in-differences]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [ODE modeling]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"} [Data viz & design]{style="font-family:'JetBrains Mono',monospace;font-size:0.8rem;padding:7px 13px;border-radius:6px;background:rgba(42,157,143,0.08);border:1px solid rgba(42,157,143,0.2);"}
:::
